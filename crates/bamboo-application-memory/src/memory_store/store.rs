...
use bamboo_application_agent::workspace_state;
...
impl MemoryStore {
    ...
    pub fn with_defaults() -> Self {
        Self {
            resolver: MemoryPathResolver::from_data_dir(bamboo_infrastructure_config::paths::bamboo_dir()),
        }
    }
    ...
    pub async fn inspect_scope(
        ...
        Ok(MemoryInspectResult {
            ...
            topic_paths: docs
                .iter()
                .map(|doc| bamboo_infrastructure_config::paths::path_to_display_string(&doc.path))
                .collect(),
        })
    }
