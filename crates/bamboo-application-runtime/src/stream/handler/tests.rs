...
use bamboo_infrastructure_llm::provider::LLMError;
use bamboo_infrastructure_llm::{LLMChunk, LLMStream};

use super::{consume_llm_stream, consume_llm_stream_silent};

fn build_stream(items: Vec<bamboo_infrastructure_llm::provider::Result<LLMChunk>>) -> LLMStream {
