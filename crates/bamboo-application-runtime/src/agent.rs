...
impl Agent {
    ...
    pub fn storage(&self) -> &Arc<dyn bamboo_application_agent::storage::Storage> {
...
impl AgentBuilder {
    ...
    pub fn storage(mut self, v: Arc<dyn bamboo_application_agent::storage::Storage>) -> Self {
    ...
    pub fn attachment_reader(
        mut self,
        v: Arc<dyn bamboo_application_agent::storage::AttachmentReader>,
    ) -> Self {
        self.inner = self.inner.attachment_reader(v);
        self
    }

    pub fn skill_manager(mut self, v: Arc<bamboo_application_skills::SkillManager>) -> Self {
        self.inner = self.inner.skill_manager(v);
        self
    }

    pub fn metrics_collector(mut self, v: bamboo_application_metrics::MetricsCollector) -> Self {
        self.inner = self.inner.metrics_collector(v);
        self
    }

    pub fn config(mut self, v: Arc<tokio::sync::RwLock<bamboo_infrastructure_config::Config>>) -> Self {
        self.inner = self.inner.config(v);
        self
    }

    pub fn provider(mut self, v: Arc<dyn bamboo_infrastructure_llm::LLMProvider>) -> Self {
        self.inner = self.inner.provider(v);
        self
    }

    pub fn default_tools(mut self, v: Arc<dyn bamboo_application_agent::tools::ToolExecutor>) -> Self {
