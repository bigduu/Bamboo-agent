...
use bamboo_application_agent::tools::{
...
pub(super) async fn execute_tool_call_only(
    ...
    let is_mutating = bamboo_application_tools::orchestrator::classify_tool(tool_name)
        == bamboo_application_tools::orchestrator::ToolMutability::Mutating;
    let mut emitter =
        bamboo_application_tools::events::ToolEmitter::new(&ctx.tool_call.id, tool_name, is_mutating);
    ...
    let result = bamboo_application_agent::tools::executor::execute_tool_call_with_context(
        ctx.tool_call,
        ctx.tools.as_ref(),
...
pub(super) async fn apply_tool_execution_outcome(
    ...
    let is_mutating = bamboo_application_tools::orchestrator::classify_tool(&tool_name_for_meta)
        == bamboo_application_tools::orchestrator::ToolMutability::Mutating;
