...
use bamboo_application_agent::tools::{handle_tool_result_with_agentic_support, ToolHandlingOutcome};
use bamboo_application_agent::AgentEvent;
use bamboo_application_tools::exposure::activate_discoverable_tools;
