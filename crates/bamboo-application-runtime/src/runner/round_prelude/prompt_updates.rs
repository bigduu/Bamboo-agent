...
use crate::config::PromptMemoryFlags;
...
use bamboo_application_agent::PromptSnapshot;
        ...
        super::super::session_setup::prompt_setup::read_prompt_snapshot_metadata(session)
            .unwrap_or_else(|| PromptSnapshot {
                ...
                instruction_context: session.metadata.get("workspace_path").and_then(
                    |workspace_path| {
                        crate::context::instruction::build_instruction_prompt_context(
                            workspace_path,
                        )
                    },
                ),
...
fn build_round_prompt_sections(
    prompt: &str,
) -> Vec<crate::runner::session_setup::prompt_setup::PromptSection> {
    use crate::runner::session_setup::prompt_setup::{
