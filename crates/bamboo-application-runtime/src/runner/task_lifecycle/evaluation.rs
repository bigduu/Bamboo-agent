...
use bamboo_domain_session::task::{TaskBlocker, TaskBlockerKind, TaskEvidence, TaskEvidenceKind};
...
use crate::task_evaluation::evaluate_task_progress;
        ...
        Ok(evaluation_result) => {
            ...
            if evaluation_result.needs_evaluation && !evaluation_result.updates.is_empty() {
                ...
                for update in evaluation_result.updates {
                    ...
                    if matches!(status, bamboo_domain_session::TaskItemStatus::Completed) {
                        ...
                        if !required_criteria.is_empty() {
                            ...
                            if !missing.is_empty() {
                                status = bamboo_domain_session::TaskItemStatus::InProgress;
