...
pub(super) async fn inject_external_memory_into_system_message(
    ...
    prompt_memory_flags: crate::config::PromptMemoryFlags,
...
pub(super) async fn inject_external_memory_into_system_message_with_store(
    session: &mut bamboo_application_agent::Session,
    memory: &bamboo_application_memory::memory_store::MemoryStore,
    prompt_memory_flags: crate::config::PromptMemoryFlags,
    runtime_context: Option<&PromptMemoryRuntimeContext>,
) {
...
pub(super) fn inject_task_list_into_system_message(session: &mut bamboo_application_agent::Session) {
