...
use bamboo_application_metrics::storage::MetricsStorage;
use bamboo_application_metrics::types::{RoundStatus, SessionMetricsFilter, SessionStatus, TokenUsage};
...
async fn wait_for_session(
    ...
    session_id: &str,
) -> bamboo_application_metrics::types::SessionMetrics {
    for _ in 0..100 {
...
async fn wait_for_session_detail(
    storage: &SqliteMetricsStorage,
    session_id: &str,
) -> bamboo_application_metrics::types::SessionDetail {
    for _ in 0..100 {
