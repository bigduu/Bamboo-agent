...
use bamboo_application_memory::budget::counter::TokenCounter;
use bamboo_application_memory::budget::HeuristicTokenCounter;
...
impl ToolOutputManager {
    ...
    pub fn with_defaults() -> Self {
        let artifacts_dir = bamboo_infrastructure_config::paths::bamboo_dir().join("artifacts");
