...
impl Tool for BrowserTool {
    ...
    fn parameters_schema(&self) -> Value {
        json!({
            "type":"object",
            "properties": {
                "action":{"type":"string","enum":["tabs","new_tab","activate_tab","close_tab","navigate","history","viewport","snapshot","click","click_at","hover","drag","fill","select_option","type","press","key","scroll","download","screenshot"]},
                ...
                "delta_x":{"type":"number"},
                "delta_y":{"type":"number"},
                "expected_epoch":{"type":"integer","description":"Required for new_tab/activate_tab/close_tab/history/viewport/click/click_at/hover/drag/fill/select_option/type/press/key/scroll/download: page_epoch from a prior snapshot or action result; rejects stale actions"},
