...
//! byte-bounded historical retention enforced at startup. The standalone server
//! has a stable `info` default while embedding APIs can opt into
//! build-profile-derived stdout levels; files remain `info` unless explicitly
//! overridden.
