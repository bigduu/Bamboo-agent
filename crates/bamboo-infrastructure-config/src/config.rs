...
use bamboo_application_tool_types::tool_names::normalize_tool_ref;
...
pub struct Config {
    ...
    pub mcp: bamboo_application_tool_types::mcp_config::McpConfig,
...
impl Config {
    ...
    pub fn hydrate_mcp_secrets_from_encrypted(&mut self) {
        for server in self.mcp.servers.iter_mut() {
            match &mut server.transport {
                bamboo_application_tool_types::mcp_config::TransportConfig::Stdio(stdio) => {
                ...
                bamboo_application_tool_types::mcp_config::TransportConfig::Sse(sse) => {
    ...
    fn create_default() -> Self {
        Config {
            ...
            access_control: None,
            memory: None,
            mcp: bamboo_application_tool_types::mcp_config::McpConfig::default(),
            extra: BTreeMap::new(),
        }
    }
  ...
  "https_proxy_auth_encrypted": "{encrypted}"
    ...
    fn config_save_persists_mcp_servers_in_mainstream_format() {
        ...
        config.mcp.servers = vec![
            bamboo_application_tool_types::mcp_config::McpServerConfig {
                id: "stdio-secret".to_string(),
                name: None,
                enabled: true,
                transport: bamboo_application_tool_types::mcp_config::TransportConfig::Stdio(
                    bamboo_application_tool_types::mcp_config::StdioConfig {
                ...
                reconnect: bamboo_application_tool_types::mcp_config::ReconnectConfig::default(),
                allowed_tools: vec![],
                denied_tools: vec![],
            },
            bamboo_application_tool_types::mcp_config::McpServerConfig {
                ...
                name: None,
                enabled: true,
                transport: bamboo_application_tool_types::mcp_config::TransportConfig::Sse(bamboo_application_tool_types::mcp_config::SseConfig {
                    url: "http://localhost:8080/sse".to_string(),
                    headers: vec![bamboo_application_tool_types::mcp_config::HeaderConfig {
