...
use bamboo_application_agent::{PendingQuestion, Session};

use crate::errors::RespondError;
use crate::repository::SessionAccess;
use crate::types::RespondInput;
...
pub fn update_or_append_tool_result_message(
    ...
    session.add_message(bamboo_application_agent::Message::tool_result_with_status(
        tool_call_id,
