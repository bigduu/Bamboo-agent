...
use bamboo_application_runtime::context::{
    build_env_prompt_context, build_workspace_prompt_context,
};
use bamboo_application_runtime::runner::refresh_prompt_snapshot;
use bamboo_application_skills::selection::normalize_selected_skill_ids;
use bamboo_domain_session::Message;
use bamboo_infrastructure_config::paths::path_to_display_string;
use sha2::{Digest, Sha256};
use std::path::Path;

use crate::errors::ChatError;
use crate::repository::SessionAccess;
use crate::types::ChatTurnInput;
...
pub fn resolve_workspace_path(
    ...
    workspace_path_from_request
        ...
        .or_else(|| {
            bamboo_infrastructure_config::Config::from_data_dir(data_dir.map(Path::to_path_buf))
