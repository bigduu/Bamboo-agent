...
use bamboo_application_agent::{Session, parse_prompt_external_memory_sections};
use bamboo_application_runtime::runner::read_prompt_snapshot;
use bamboo_domain_session::types::PromptSnapshot;
...
const WORKSPACE_CONTEXT_START_MARKER: &str =
    bamboo_application_runtime::context::WORKSPACE_CONTEXT_START_MARKER;
const WORKSPACE_CONTEXT_END_MARKER: &str =
    bamboo_application_runtime::context::WORKSPACE_CONTEXT_END_MARKER;
const WORKSPACE_CONTEXT_PREFIX: &str =
    bamboo_application_runtime::context::WORKSPACE_CONTEXT_PREFIX;

const INSTRUCTION_CONTEXT_START_MARKER: &str =
    bamboo_application_runtime::context::instruction::INSTRUCTION_CONTEXT_START_MARKER;
const INSTRUCTION_CONTEXT_END_MARKER: &str =
    bamboo_application_runtime::context::instruction::INSTRUCTION_CONTEXT_END_MARKER;

const ENV_CONTEXT_START_MARKER: &str = bamboo_application_runtime::context::ENV_CONTEXT_START_MARKER;
const ENV_CONTEXT_END_MARKER: &str = bamboo_application_runtime::context::ENV_CONTEXT_END_MARKER;
...
pub fn build_system_prompt_snapshot(session: &Session, default_prompt: &str) -> PromptSnapshot {
    ...
    let workspace_context = metadata_value(session, "workspace_path")
        .as_deref()
        .and_then(bamboo_application_runtime::context::build_workspace_prompt_context)
...
fn resolve_effective_system_prompt(session: &Session, default_prompt: &str) -> String {
    use bamboo_application_agent::Role;
...
fn split_legacy_workspace_context(prompt: &str) -> (String, Option<String>) {
    ...
    let guidance = bamboo_application_runtime::context::workspace_prompt_guidance();
...
mod tests {
    ...
    use bamboo_domain_session::types::PromptMemoryObservability;
    ...
    fn snapshot_prefers_shared_prompt_snapshot_metadata_when_present() {
        ...
        session.metadata.insert(
            ...
            serde_json::to_string(&bamboo_application_runtime::runner::PromptSnapshot {
