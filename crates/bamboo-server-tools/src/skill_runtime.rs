...
use bamboo_application_skills::resource_helpers::{
...
use bamboo_application_skills::access_control::{
    self, SkillAccessError, SkillSessionPort,
};
use bamboo_application_skills::runtime_metadata::LAST_RESOURCE_READ_SUMMARY_METADATA_KEY;
    ...
    async fn execute_with_context(
        ...
        Ok(ToolResult {
            ...
            result: json!({
                ...
                "skill_base_dir": bamboo_infrastructure_config::paths::path_to_display_string(&canonical_skill_root),
...
mod tests {
    ...
    use bamboo_application_skills::runtime_metadata::{
