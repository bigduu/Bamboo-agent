...
use bamboo_domain_session::{Role, Message, MessagePart};
...
fn tool_call_to_tool_use_block(tool_call: &bamboo_domain_session::ToolCall) -> Value {
    ...
    match event_type {
        ...
        "content_block_start" => {
            ...
            Ok(Some(LLMChunk::ToolCalls(vec![
                bamboo_domain_session::ToolCall {
                    id: id.to_string(),
