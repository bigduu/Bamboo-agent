...
impl From<bamboo_domain_session::MessagePart> for ContentPart {
    fn from(part: bamboo_domain_session::MessagePart) -> Self {
        match part {
            bamboo_domain_session::MessagePart::Text { text } => ContentPart::Text { text },
            bamboo_domain_session::MessagePart::ImageUrl {
                image_url: url_ref,
...
impl From<ContentPart> for bamboo_domain_session::MessagePart {
    fn from(part: ContentPart) -> Self {
        match part {
            ContentPart::Text { text } => bamboo_domain_session::MessagePart::Text { text },
            ContentPart::ImageUrl { image_url } => bamboo_domain_session::MessagePart::ImageUrl {
...
impl From<ImageUrl> for bamboo_domain_session::ImageUrlRef {
    fn from(url: ImageUrl) -> Self {
        bamboo_domain_session::ImageUrlRef {
            url: url.url,
            detail: url.detail,
        }
    }
...
impl From<bamboo_domain_session::ImageUrlRef> for ImageUrl {
    fn from(url: bamboo_domain_session::ImageUrlRef) -> Self {
        ImageUrl {
            url: url.url,
            detail: url.detail,
        }
