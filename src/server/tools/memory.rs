    ...
    async fn execute_with_context(
        ...
        match parsed {
            ...
            MemoryArgs::Query {
                ...
                Ok(ToolResult {
                    ...
                    result: json!({
                        ...
                        "success": true,
                        "data": result,
                        "summary": crate::agent::core::memory_store::summary_json(result.returned_count, result.matched_count),
                        "warnings": [],
                    }).to_string(),
            ...
            MemoryArgs::Get {
                ...
                let (body, truncated) =
                    crate::agent::core::memory_store::truncate_chars(&doc.body, max_chars);
                doc.body = body;
                Ok(ToolResult {
                    success: true,
                    result: json!({
    ...
    async fn memory_session_append_enforces_shared_limit() {
        ...
        tool.execute_with_context(
            json!({
                ...
                "topic":"limit",
                "content":"x".repeat(crate::agent::tools::tools::session_memory::MAX_SESSION_NOTE_CHARS - 1)
            }),
