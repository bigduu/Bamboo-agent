    ...
    let items: Vec<TodoItemResponse> = todo_list
        ...
        .map(|item| TodoItemResponse {
            ...
            status: match item.status {
                crate::agent::core::TodoItemStatus::Pending => "pending".to_string(),
                crate::agent::core::TodoItemStatus::InProgress => "in_progress".to_string(),
                crate::agent::core::TodoItemStatus::Completed => "completed".to_string(),
                crate::agent::core::TodoItemStatus::Blocked => "blocked".to_string(),
            },
