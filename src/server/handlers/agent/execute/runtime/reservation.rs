...
use crate::{
    ...
    server::app_state::{AgentRunner, AgentStatus, AppState},
};

pub(in crate::server::handlers::agent::execute) enum RunnerReservation {
    Started(CancellationToken),
    AlreadyRunning,
}

pub(in crate::server::handlers::agent::execute) async fn reserve_runner(
    state: &AppState,
    session_id: &str,
