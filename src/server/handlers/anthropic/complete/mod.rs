...
use crate::agent::{
    core::{tools::ToolSchema, Message},
    llm::{api::models::StreamOptions, providers::anthropic::api_types::AnthropicCompleteRequest},
};
...
pub async fn complete(
    ...
    if let Err(error) = crate::server::message_hooks::apply_message_preflight_hooks(
