    ...
    pub fn best_practices(&self) -> &'static [&'static str] {
        match self.language {
            GuideLanguage::Chinese => &[
                ...
                "For multi-step or non-trivial work, always use TodoWrite and keep task status updated continuously.",
                "Keep exactly one TodoWrite item in in_progress whenever possible; mark items completed immediately after finishing.",
