...
use super::super::todo_context::{TodoLoopContext, ToolCallRecord};

/// 构建用于 TodoList 评估的 messages
pub fn build_todo_evaluation_messages(ctx: &TodoLoopContext, _session: &Session) -> Vec<Message> {
...
pub(super) fn format_recent_tools(ctx: &TodoLoopContext, limit: usize) -> String {
