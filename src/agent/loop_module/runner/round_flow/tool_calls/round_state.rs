...
use crate::agent::metrics::{MetricsCollector, RoundStatus as MetricsRoundStatus, TokenUsage};
...
impl ToolCallsRoundState {
    pub(super) fn apply_tool_execution_result(
        &mut self,
        tool_execution: crate::agent::loop_module::runner::tool_execution::RoundToolExecutionResult,
    ) {
