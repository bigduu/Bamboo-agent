...
mod tests {
    ...
    fn test_message_conversion() {
        ...
        use bamboo_llm::api::models::ChatMessage as OpenAIChatMessage;
        use bamboo_llm::protocol::ToProvider;
    ...
    fn test_available_providers() {
        ...
        let providers = bamboo_llm::AVAILABLE_PROVIDERS;
