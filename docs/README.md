...
| [`lifecycle-hooks.md`](lifecycle-hooks.md) | Configure command or sandboxed JavaScript lifecycle handlers, event payloads, decisions, resource limits, and practical examples. |
